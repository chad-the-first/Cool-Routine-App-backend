...
const signUp = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (existingUsername) {
            throw (0, http_errors_1.default)(409, "Username already taken. Please choose a different on or login instead.");
        }
...
const login = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!user) {
            throw (0, http_errors_1.default)(401, "Invalid creadentials");
        }
